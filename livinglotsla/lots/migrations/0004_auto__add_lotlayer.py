...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lots_lotlayer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
        ))
        db.send_create_signal(u'lots', ['LotLayer'])

        # Adding M2M table for field lots on 'LotLayer'
        m2m_table_name = db.shorten_name(u'lots_lotlayer_lots')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lotlayer', models.ForeignKey(orm[u'lots.lotlayer'], null=False)),
            ('lot', models.ForeignKey(orm[u'lots.lot'], null=False))
        ))
        db.create_unique(m2m_table_name, ['lotlayer_id', 'lot_id'])


    def backwards(self, orm):
        # Deleting model 'LotLayer'
        db.delete_table(u'lots_lotlayer')

        # Removing M2M table for field lots on 'LotLayer'
        db.delete_table(db.shorten_name(u'lots_lotlayer_lots'))
