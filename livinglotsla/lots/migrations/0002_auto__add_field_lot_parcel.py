...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lot.parcel'
        db.add_column(u'lots_lot', 'parcel',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='lot_model', null=True, to=orm['parcels.Parcel']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lot.parcel'
        db.delete_column(u'lots_lot', 'parcel_id')
