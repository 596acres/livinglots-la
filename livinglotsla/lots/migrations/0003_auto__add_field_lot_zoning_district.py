...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lot.zoning_district'
        db.add_column(u'lots_lot', 'zoning_district',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['zoning.ZoningDistrict'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lot.zoning_district'
        db.delete_column(u'lots_lot', 'zoning_district_id')
