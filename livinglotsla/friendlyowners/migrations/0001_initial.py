...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FriendlyOwner'
        db.create_table(u'friendlyowners_friendlyowner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('lot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lots.Lot'], null=True, blank=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'friendlyowners', ['FriendlyOwner'])

        # Adding M2M table for field parcels on 'FriendlyOwner'
        m2m_table_name = db.shorten_name(u'friendlyowners_friendlyowner_parcels')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('friendlyowner', models.ForeignKey(orm[u'friendlyowners.friendlyowner'], null=False)),
            ('parcel', models.ForeignKey(orm[u'parcels.parcel'], null=False))
        ))
        db.create_unique(m2m_table_name, ['friendlyowner_id', 'parcel_id'])


    def backwards(self, orm):
        # Deleting model 'FriendlyOwner'
        db.delete_table(u'friendlyowners_friendlyowner')

        # Removing M2M table for field parcels on 'FriendlyOwner'
        db.delete_table(db.shorten_name(u'friendlyowners_friendlyowner_parcels'))


    models = {
        u'friendlyowners.friendlyowner': {
            'Meta': {'object_name': 'FriendlyOwner'},
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lot': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lots.Lot']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'parcels': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['parcels.Parcel']", 'symmetrical': 'False'}),
