...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'page_page', (
            ...
            ('publication_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 30, 0, 0))),
        ...
        # Adding model 'PathwayListContent'
        db.create_table(u'page_page_pathwaylistcontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pathwaylistcontent_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'page', ['PathwayListContent'])
        ...
        # Adding model 'RssFeedContent'
        db.create_table(u'page_page_rssfeedcontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rsssync.RssFeed'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rssfeedcontent_set', to=orm['page.Page'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'page', ['RssFeedContent'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PathwayListContent'
        db.delete_table(u'page_page_pathwaylistcontent')

        # Deleting model 'RecentActivitiesContent'
        db.delete_table(u'page_page_recentactivitiescontent')

        # Deleting model 'RssFeedContent'
        db.delete_table(u'page_page_rssfeedcontent')
    ...
    models = {
        ...
        u'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 30, 0, 0)'}),
        ...
        u'page.pathwaylistcontent': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'PathwayListContent', 'db_table': "u'page_page_pathwaylistcontent'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pathwaylistcontent_set'", 'to': u"orm['page.Page']"}),
            'region': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        u'page.rssfeedcontent': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'RssFeedContent', 'db_table': "u'page_page_rssfeedcontent'"},
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rsssync.RssFeed']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rssfeedcontent_set'", 'to': u"orm['page.Page']"}),
            'region': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'rsssync.rssfeed': {
