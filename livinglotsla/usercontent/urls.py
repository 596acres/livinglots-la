...
from .views import (AddFileView, AddFileSuccessView, AddNoteView,
                    AddNoteSuccessView, AddPhotoView, AddPhotoSuccessView)
...
urlpatterns = patterns('',
    ...
    url(r'^files/(?P<usercontent_pk>\d+)/add/success/$',
        AddFileSuccessView.as_view(),
